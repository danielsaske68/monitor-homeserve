...
PUBLIC_URL = os.getenv("PUBLIC_URL")  # 🔥 IMPORTANTE EN RAILWAY
...
def reset_webhook():
    try:
        requests.get(f"{TELEGRAM_API}/deleteWebhook?drop_pending_updates=true", timeout=10)
...
def webhook():
    ...
    if "message" in data:
        ...
        try:
            ...
            elif accion.startswith("CAMBIAR"):
